...
func (m *CircularQueue) EnQueue(value int) bool {
	if len(m.queue) == m.k {
		return false
	}
...
func (m *CircularQueue) DeQueue() bool {
	if len(m.queue) == 0 {
		return false
	}
...
func (m *CircularQueue) Front() int {
	if len(m.queue) == 0 {
		return -1
	}
...
func (m *CircularQueue) IsEmpty() bool {
	return len(m.queue) == 0
}

// IsFull checks whether the circular queue is full or not. */
func (m *CircularQueue) IsFull() bool {
